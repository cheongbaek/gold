...
white1/sound/*.mp3 안내 음성을 새로 만들거나, 문구를 귀로 확인할 때 쓴다.
  (★[2026-08-14] 음원 폴더가 nxde/sound → white1/sound 로 옮겨 갔다★ — 이 도구는
   파일을 저장하지 않으므로, 만든 음성은 사람이 그 폴더에 직접 넣는다)
...
════════════════════════════════════════════════════════════════════════════════
  · ★인터넷이 필요하다★ edge-tts 는 Microsoft Edge 의 온라인 음성합성을 쓴다.
    ...
    만들어 둔 white1/sound/*.mp3 를 재생하는 방식(nxde/sound.py)이고, 이 파일은 그
